...
export PCT_OPTIONS="
  ...
  $PW
"
bash -c "$(wget -qLO - https://raw.githubusercontent.com/maddoc1/Proxmox/main/ct/create_lxc.sh)" || exit
...
lxc-attach -n $CTID -- bash -c "$(wget -qLO - https://raw.githubusercontent.com/maddoc1/Proxmox/main/setup/$var_install.sh)" || exit
